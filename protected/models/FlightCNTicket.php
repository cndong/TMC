...
class FlightCNTicket extends QActiveRecord {
    ...
    public function rules() {
        return array(
            array('userID, departmentID, companyID, orderID, segmentID, passenger, isInsured, flightNo, craftCode, craftType, ticketPrice, airportTax, oilTax, realTicketPrice, insurePrice, cabin, cabinClass, cabinClassName, departTime, arriveTime, departTerm, arriveTerm, status', 'required'),
            array('userID, departmentID, companyID, orderID, segmentID, ticketID, ticketPrice, airportTax, oilTax, realTicketPrice, insurePrice, resignHandlePrice, refundHandlePrice, realTicketPrice, realResignHandlePrice, realRefundHandlePrice, refundPrice, payPrice, tradeNo, craftType, cabinClass, departTime, arriveTime, status, deleted, ctime, utime', 'numerical', 'integerOnly' => True),
