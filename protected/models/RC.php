...
class RC {
    ...
    const RC_CONTACTER_MODIFY_ERROR = 100210;
    const RC_CONTACTER_DELETE_ERROR = 100210;
    const RC_ADDRESS_HAD_EXISTS = 100214;
    const RC_ADDRESS_NOT_EXISTS = 100215;
    const RC_ADDRESS_CREATE_ERROR = 100216;
    const RC_ADDRESS_MODIFY_ERROR = 100216;
    const RC_ADDRESS_DELETE_ERROR = 100216;
    const RC_ADDRESS_PCC_NOT_EXISTS = 100217;
    const RC_PASSENGER_HAD_EXISTS = 100217;
    const RC_PASSENGER_NOT_EXISTS = 100218;
    const RC_PASSENGER_CREATE_ERROR = 100219;
    const RC_PASSENGER_MODIFY_ERROR = 100219;
    const RC_PASSENGER_DELETE_ERROR = 100219;
