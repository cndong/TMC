...
class RC {
    ...
    const RC_STATUS_TICKET_ERROR = 100239;
    const RC_REASON_ERROR = 100240;
    const RC_HAVE_NO_REVIEW_PRIVILEGE = 100241;
    const RC_MUST_INSURE = 100242;
    const RC_USER_ROLE_NOT_EXISTS = 200243;
