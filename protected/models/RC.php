...
class RC {
    ...
    const RC_ADDRESS_MODIFY_ERROR = 100217;
    const RC_ADDRESS_DELETE_ERROR = 100218;
    const RC_ADDRESS_PCC_NOT_EXISTS = 100219;
    const RC_PASSENGER_HAD_EXISTS = 100220;
    const RC_PASSENGER_NOT_EXISTS = 100221;
