<?php
class BossRole extends QActiveRecord {
    ...
    public function getMenus() {
        ...
        $sql = 'SELECT id,name,controller,action,icon,parentID,sort, isHide,TRIM(LEADING "," FROM CONCAT(path,",",id)) as nPath FROM ' . BossMenu::model()->tableName() . " {$where} ORDER BY path,sort";
