        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <form class="form-inline" action="<?php echo $this->createUrl('userList'); ?>">
                    <span>员工列表</span>
                    <input name="companyID" type="text" class="form-control input-sm" value="<?php echo $params['companyID']; ?>" placeholder="企业编号" />
                    ...
                    <button class="c_create btn btn-danger btn-sm pull-right" data-create-type="user" type="button">+添加员工</button>
                </form>
            </div>
